...
Slingshot.Upload = function (directive, metaData) {
  ...
  function cordova_transfer(callback, onProgress){
  ...
  _.extend(self, {
    ...
    */
    ...
    send: function (file, callback, onProgress) {
      ...
      function _send(){
        self.request(function (error, instructions) {
          ...
          self.transfer(callback, onProgress);
        });
      }
    ...
    transfer: function (callback, onProgress) {
      ...
      {
        return cordova_transfer(callback, onProgress);
      }
